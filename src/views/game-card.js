...
export class Game extends Component
{
    ...
    render()
    {
        return(
        <>
        <a className="game-link" href={this.props.href} target="_blank">
        <Card className="game">
            ...
            <img className="card-img-botton" src={this.props.cornerIcon} style={{maxWidth: 80, maxHeight: 80, position: "absolute", right: 30, bottom: 20}} />
        </Card>
        </a>
        </>
        );
